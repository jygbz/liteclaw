...
from liteclaw.core.context import AgentState
...
class TestAgent(unittest.TestCase):
    ...
    @patch('liteclaw.core.provider.get_provider')
    @patch('liteclaw.core.skill_loader.load_dynamic_skills')
    @patch('liteclaw.core.tools.builtins.BUILTIN_TOOLS', [])
